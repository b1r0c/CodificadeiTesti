...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:tei="http://www.tei-c.org/ns/1.0" version="1.0">
   ...
   <xsl:template match="tei:surface[@xml:id='fronte1' or @xml:id='fronte2' or @xml:id='fronte3']/tei:graphic">
      <img id="imgfronte" src="{@url}" />
      <xsl:apply-templates />
   </xsl:template>
   <xsl:template match="tei:sourceDesc[@xml:id='sourceDesc1' or @xml:id='sourceDesc2' or @xml:id='sourceDesc3']">
      <div class="info">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   ...
   <xsl:template match="tei:titleStmt[@xml:id='titleStmt1' or @xml:id='titleStmt2' or @xml:id='titleStmt3']">
      <div class="no">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   <xsl:template match="tei:editionStmt[@xml:id='editionStmt1' or @xml:id='editionStmt2' or @xml:id='editionStmt3']">
      <div class="no">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   <xsl:template match="tei:publicationStmt[@xml:id='publicationStmt1' or @xml:id='publicationStmt2' or @xml:id='publicationStmt3']">
      <div class="no">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   <xsl:template match="tei:notesStmt[@xml:id='notesStmt1' or @xml:id='notesStmt2'or @xml:id='notesStmt3']">
      <div class="no">
         <xsl:apply-templates />
      </div>
   </xsl:template>
   ...
   <xsl:template match="tei:title"> <!-- per il titolo iniziale "Cartoline - Edizione diplomatico-interpretativa" -->
      <p class="title">
         <xsl:apply-templates />
      </p>
   </xsl:template>
   <xsl:template match="tei:title[@xml:id='tit1' or @xml:id='tit2' or @xml:id='tit3']"> <!-- per i titoli sottolineati -->
      <p class="titolo">
         <xsl:apply-templates />
      </p>
   </xsl:template>
   <xsl:template match="tei:title[@xml:id='titolo21' or @xml:id='titolo22' or @xml:id='titolo23']"> <!-- per i titoli delle immagini -->
      <p class="titolo2">
         <xsl:apply-templates />
      </p>
   </xsl:template>
   ...
   <xsl:template match="tei:div[@xml:id='indirizzo1' or @xml:id='indirizzo2' or @xml:id='indirizzo3']">
      <div id="indirizzo">
      <b>
         <br />
